...
CREATE TABLE IF NOT EXISTS artists (
  ...
  -- Payment details
  payment_method    ENUM('bank','mobile_money','paypal','none') NOT NULL DEFAULT 'none',
  bank_name         VARCHAR(100) DEFAULT NULL,
  account_number    VARCHAR(50)  DEFAULT NULL,
  account_name      VARCHAR(100) DEFAULT NULL,
  mobile_network    ENUM('mtn','vodafone','airteltigo') DEFAULT NULL,
  mobile_number     VARCHAR(20)  DEFAULT NULL,
  paypal_email      VARCHAR(120) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS earnings (
  ...
  type       ENUM('download','stream','bonus','manual') NOT NULL DEFAULT 'download',
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (artist_id) REFERENCES artists(id) ON DELETE CASCADE,
  FOREIGN KEY (song_id)   REFERENCES songs(id)   ON DELETE CASCADE,
  INDEX idx_artist  (artist_id),
...
CREATE TABLE IF NOT EXISTS payouts (
  ...
  payment_method  ENUM('bank','mobile_money','paypal') NOT NULL,
  payment_details JSON           NOT NULL,  -- Store payment details as JSON
